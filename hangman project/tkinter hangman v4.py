...
with open("C:/Users/Abdelwakil/Desktop/python/hangman project/words lists/liste_francais.txt") as file:
    text=file.read()
...
def show_func():
    global answer
    answer=Label(window,text=w,font="verdana 20",textvariable=var_2)
...
button_è=Button(window,text="è",padx=20,pady=10,command=func_è)
button_ê=Button(window,text="ê",padx=20,pady=10,command=func_ê)

##################creating buttons for letters###############

surrender=Button(window,text="show word",padx=20,command=show_func)

new_game=Button(window,text="play again",padx=20,command=new_game)

hide_answer=Button(window,text="hide answer",padx=20,command=hide_answer)
...
button_z.place(x=460,y=400)
button_e.place(x=520,y=400)
button_r.place(x=580,y=400)
button_t.place(x=640,y=400)
button_y.place(x=700,y=400)
button_u.place(x=760,y=400)
button_i.place(x=820,y=400)
button_o.place(x=880,y=400)
button_p.place(x=940,y=400)
button_q.place(x=400,y=450)
button_s.place(x=460,y=450)
button_d.place(x=520,y=450)
button_f.place(x=580,y=450)
button_g.place(x=640,y=450)
button_h.place(x=700,y=450)
button_j.place(x=760,y=450)
button_k.place(x=820,y=450)
button_l.place(x=880,y=450)
button_m.place(x=940,y=450)
button_w.place(x=400,y=500)
button_x.place(x=460,y=500)
button_c.place(x=520,y=500)
button_v.place(x=580,y=500)
button_b.place(x=640,y=500)
button_n.place(x=700,y=500)
button_é.place(x=760,y=500)
button_è.place(x=820,y=500)
button_ê.place(x=880,y=500)
